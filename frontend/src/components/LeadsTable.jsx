// Lists leads and manages analysis, drafts, sending, and deletion.
import { useState, useEffect } from 'react'
import { api, draftEmailForLead, friendlyError } from '../api'
...
const BORDERLINE_HINT =
  ...
  `emails are drafted only for scores above ${EMAIL_THRESHOLD}. Worth reviewing by hand.`
...
function LeadCard({ lead, onEdit, onDelete, onRefresh }) {
  ...
  async function handleDraftEmail() {
    ...
    setErr(null)
    try {
      const res = await draftEmailForLead(lead.id)
